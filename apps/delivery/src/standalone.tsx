 ...
 * capacity and says costs are unavailable. That is the same code path as a failed remote in the
 * shell, which makes this the cheapest possible way to exercise it.
 */
