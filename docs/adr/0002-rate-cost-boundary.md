...
**Status:** accepted · **Relates to:** R1, R2, F7 · *This is the decision §4 of the brief says is
being assessed.*
...
* **C.** People publishes a *month quote* — the priced structure of the month — and Delivery
...
A month therefore has a *single* number that fully describes its price, independent of how much
...
* Against **B**: a per-cell RPC is the wrong granularity. Pricing the visible grid means one call
  ...
  into hours. B is chattier *and* leaks the same number anyway.
...
**What each side ends up owning.** People owns *what an hour of this person costs in this month*.
Delivery owns *how many hours are in this cell and how they roll up*. Neither can state the other's
