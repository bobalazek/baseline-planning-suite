...
apportionment adjusts *cells* to match a *total* — but each leaf cell belongs to one row group and
...
floating-point error, not to within a cent. The drift described here is between a *derived* value
